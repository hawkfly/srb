...
(function () {
	...
	window.UEDITOR_HOME_URL = prjname+"/webresources/jsplugins/ueditor/";
    ...
    window.UEDITOR_CONFIG = {
    	...
    	, toolbars:[
    	  ['undo','bold','italic', 'underline', 'fontfamily', 'fontsize','forecolor','|',
    	   'link', 'unlink','|',
    	   'justifyleft', 'justifycenter', 'justifyright','|',
    	   'insertimage','attachment','ysyd','pagebreak','fullscreen','expand'],
    	  ['inserttable', 'deletetable','wordimage', 'formatmatch', 'indent', 'source']
    	]
	  	//工具栏是否启用首行显示其他隐藏的模式
	    ,isFirstOthersToolbar:true
    	...
    	,webAppKey:"ujdG8ck53vIvejbInx3L5IvB"
