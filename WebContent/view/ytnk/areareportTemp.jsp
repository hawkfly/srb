...
<wx:searchbox></wx:searchbox>
    <table>
		<tr class="tabletd">
			...
			<td class="tongyi"><wx:data col="F_MC" showdata="true" showlabel="false"></wx:data></td>
        ...
        <tr class="tabletd">
        	<td><div class='label' align="left" style="width:70px; height:30px">区&nbsp;&nbsp;域：</div></td>
			<td class="tongyi"><wx:data col="F_QY" showdata="true" showlabel="false"></wx:data></td>
    ...
    <div class="tabletd">
        <wx:data col="F_QYQBNR" showdata="true" showlabel="false"></wx:data>
    </div>
</body>
</html>