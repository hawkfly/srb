...
<html>
	<head>
        ...
        function zTreeOnClick(event, treeId, treeNode) {
 	 		 $.jbsf.ztree.clickCascadeWbcsReport({iframeid: 'authoritygridframe', iframelinkpageid:"zzjgPage", ztreenode:treeNode, accessmode: 'read'});
		};
        function zTreeOnAsyncSuccess(event, treeId, treeNode, msg) {
        	 var obj;
   			 var treeObj = $.fn.zTree.getZTreeObj("organizationtreeDemo");
	    	...
	    	$.jbsf.ztree.clickCascadeWbcsReport({iframeid: 'authoritygridframe', iframelinkpageid:"zzjgPage", ztreenode:obj, accessmode: 'read'});
		};
		...
		function refreshTree() {			
	    	$.fn.zTree.init($("#organizationtreeDemo"), setting);
		};
	...
	<body>
		<div id="authoritymngDiv" style="position: relative; width:100%; height: auto; overflow: hidden;">
			<div id="authorityCRUD" style="padding-top: 5px; margin-left: 5px; width: 100%; float: left;overflow: hidden;">
				...
				<div class="content_wrap" style="float: left; width: 15%; height: 100%; overflow-y: scroll;overflow-x:hidden;height:470px;">
