...
<html>
	<head>
        ...
        function zTreeOnClick(event, treeId, treeNode) {
 	 		 $.jbsf.ztree.clickCascadeWbcsReport({iframeid: 'authoritygridframe', iframelinkpageid:"qyPage", ztreenode:treeNode, accessmode: 'read'});
		};
        function zTreeOnAsyncSuccess(event, treeId, treeNode, msg) {
        	 var obj;
   			 var treeObj = $.fn.zTree.getZTreeObj("areatreeDemo");
	    	...
	    	$.jbsf.ztree.clickCascadeWbcsReport({iframeid: 'authoritygridframe', iframelinkpageid:"qyPage", ztreenode:obj, accessmode: 'read'});
		};
		...
		function refreshTree() {			
	    	$.fn.zTree.init($("#areatreeDemo"), setting);
		};
	...
	<body>
		<div id="authoritymngDiv" style="position: relative; width:100%; height: auto; overflow: hidden;">
			<div id="authorityCRUD" style="padding-top: 5px; margin-left: 5px; width: 100%; float: left;overflow: hidden;">
				...
				<div class="content_wrap" style="float: left; width: 15%; height: auto; overflow-y: scroll;overflow-x:hidden;height:550px;">
					<div class="zTreeDemoBackground left">
						<ul id="areatreeDemo" class="ztree"></ul>
					</div>
				</div>
				<div title="权限详细信息" style="float: right; width: 85%;">
