...
<span>联调集成前请仔细阅读:</span><a href="<%=path%>/other/readme.txt" target="_blank">&nbsp;readme.txt</a> 
...
<h4>前台跳转消费</h4>
<ul>
<li><a href="#" target="_self" onclick="displayConsumeDiv();">跳转网关页面支付</a>&nbsp;&nbsp;点击查看&nbsp;<a href="<%request.getContextPath();%>/ACPSample-PCGate-UTF8/other/consumeFieldSpecal.txt" target="_blank">报文特殊用法.txt</a></li>
</ul>
...
<form action="<%=path%>/form_6_2_FrontConsume" method="post" name="payForm" id="payForm" target="_blank">
                    ...
                    <table width="100%" height="100%"  border="0" cellpadding="3" cellspacing="0"  class="px14">
                      <tr>
                        ...
                        <td valign="middle">
                          ...
                          <input name="merId" type="text" value="777290058120154" >（默认商户号仅作为联调测试使用，正式上线还请使用正式申请的商户号）
                        </td>
                      </tr>
                      <tr>
...
<form action="<%request.getContextPath();%>/ACPSample-PCGate-UTF8/form_6_3_ConsumeUndo" method="post" name="payUndoForm"  id="payUndoForm" target="_blank">
...
<form action="<%request.getContextPath();%>/srb/form_6_5_Query" method="post" name="queryForm"  id="queryForm" target="_blank">
<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" bgcolor="#FFCC00">
...
<form action="<%request.getContextPath();%>/srb/form_6_6_FileTransfer" method="post" name="fileTransferForm"  id="fileTransferForm" target="_blank">
<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" bgcolor="#FFCC00">
