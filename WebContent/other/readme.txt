...
2） 此工程可以跑起来测试，建议使用IE，chrome打开
                                                     全渠道PC网关/WAP支付产品消费交易示例地址为：http://IP：端口/ACPSample-PCGate-UTF8/index.jsp
                                                     全渠道PC网关/WAP支付产品预授权交易示例地址为：http://IP：端口/ACPSample-PCGate-UTF8/index_preauth.jsp
───────────
...
ACPSample_PCGate
  ...
  │  │  │
  │  │  ├acp_sdk.properties ┈┈┈┈┈┈┈┈┈生产环境配置文件样例（使用的时候修改里边证书路径并替换掉src下的测试环境配置文件acp_sdk.properties）
  │  │  │
