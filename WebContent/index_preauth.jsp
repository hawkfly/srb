...
<span>联调集成前请仔细阅读:</span><a href="<%request.getContextPath();%>/ACPSample-PCGate-UTF8/other/readme.txt" target="_blank">&nbsp;readme.txt</a> 
...
<h4>前台跳转预授权</h4>
<ul>
<li><a href="#" onclick="displayPreAuthDiv();">跳转网关页面预授权</a>&nbsp;&nbsp;点击查看&nbsp;<a href="<%request.getContextPath();%>/ACPSample-PCGate-UTF8/other/preauthFieldSepcal.txt" target="_blank">报文特殊用法.txt</a></li>
...
<form action="<%request.getContextPath();%>/ACPSample-PCGate-UTF8/form_6_7_1_AuthDeal_Front" method="post" name="payForm" id="payForm" target="_blank">
                  ...
                  <tr>
                    ...
                    <table width="100%" height="100%"  border="0" cellpadding="3" cellspacing="0"  class="px14">
                      <tr>
                        ...
                        <td valign="middle">
                          <input name="merId" type="text" value="777290058110097" >（默认商户号仅作为联调测试使用，正式上线还请使用正式申请的商户号）
                        </td>
                      </tr>
                      <tr>
...
<form action="<%request.getContextPath();%>/ACPSample-PCGate-UTF8/form_6_7_2_AuthUndo" method="post" name="PreAuthUndoForm"  id="PreAuthUndoForm" target="_blank">
...
<form action="<%request.getContextPath();%>/ACPSample-PCGate-UTF8/form_6_7_3_AuthFinish" method="post" name="PreAuthFinishForm"  id="PreAuthFinishForm" target="_blank">
<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" bgcolor="#FFCC00">
...
<form action="<%request.getContextPath();%>/ACPSample-PCGate-UTF8/form_6_7_4_AutnFinishUndo" method="post" name="PreAuthFinishUndoForm"  id="PreAuthFinishUndoForm" target="_blank">
<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" bgcolor="#FFCC00">
...
<form action="<%request.getContextPath();%>/ACPSample-PCGate-UTF8/form_6_4_Refund" method="post" name="refundForm"  id="refundForm" target="_blank">
<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" bgcolor="#FFCC00">
...
<form action="<%request.getContextPath();%>/ACPSample-PCGate-UTF8/form_6_5_Query" method="post" name="queryForm"  id="queryForm" target="_blank">
<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" bgcolor="#FFCC00">
...
<form action="<%request.getContextPath();%>/ACPSample-PCGate-UTF8/form_6_6_FileTransfer" method="post" name="fileTransferForm"  id="fileTransferForm" target="_blank">
<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" bgcolor="#FFCC00">
