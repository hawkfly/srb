...
public class Form_6_7_3_AuthFinish extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		data.put("origQryId", "201506251004397641928");
		...
		//data = DemoBase.signData(data,"D:\\certs\\PM_700000000000001_acp.pfx", "000000");
		
		// 交易请求url 从配置文件读取
		String url = SDKConfig.getConfig().getBackRequestUrl();

		Map<String, String> resmap = DemoBase.submitUrl(data, url);

		System.out.println("请求报文=["+data.toString()+"]");
		System.out.println("应答报文=["+resmap.toString()+"]");
		
		resp.getWriter().write("请求报文=["+data.toString()+"] <br/><br/>" + "应答报文=["+resmap.toString()+"]");
	}
